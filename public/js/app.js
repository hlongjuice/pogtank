...
Vue.component('materials-items-create', __webpack_require__(40));
...
Component.options.__file = "resources\\assets\\js\\components\\materials\\items\\CreateComponent.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-816df624", Component.options)
  } else {
    hotAPI.reload("data-v-816df624", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-816df624", module.exports)
  }
}
