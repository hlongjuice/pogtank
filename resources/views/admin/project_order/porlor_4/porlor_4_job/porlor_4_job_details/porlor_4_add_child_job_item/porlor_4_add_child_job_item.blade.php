                            ...
                            <div class="portlet-body form">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div :class="{'input-error':errors.has('form.add_child_job_item_parent')}">
                                                    <multiselect
                                                        v-model="add_child_job_item.form.parent"
                                                        placeholder="พิมพ์เพื่อค้นหา" label="name" track-by="id"
                                                        :options="add_child_job_item.leaf_jobs" :option-height="104"
                                                        :show-labels="false"
                                                        :allow-empty="false"
                                                        :max-height="180"
                                                    ...
                                                    >
                                                        ...
                                                        <span class="text-secondary" slot="noResult">ไม่พบข้อมูลที่ค้นหา</span>
                                                    </multiselect>
                                                    <input v-validate="'required'"
                                                           name="add_child_job_item_parent" hidden
                                                           v-model="add_child_job_item.form.parent">
                                                </div>
                                                <span v-show="errors.has('form.add_child_job_item_parent')"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div :class="{'input-error':errors.has('form.add_child_job_item_material_type')}">
                                                    <multiselect
                                                            ...
                                                            placeholder="พิมพ์เพื่อค้นหา" label="name" track-by="id"
                                                            :options="add_child_job_item.material_types" :option-height="104"
                                                            :show-labels="false"
                                                            :allow-empty="false"
                                                            :max-height="180"
                                                    >
                                        ...
                                        {{--Material Item--}}
                                        <div class="col-xs-12 col-md-4">
                                            <div v-if="add_child_job_item.form.material_type" class="form-group">
                                                ...
                                                <div :class="{'input-error':errors.has('form.add_child_job_item_material_item')}">
                                                    <multiselect
                                                            ...
                                                            :options="add_child_job_item.material_items" :option-height="104"
                                                            :show-labels="false"
                                                            :allow-empty="false"
                                                            :max-height="180"
