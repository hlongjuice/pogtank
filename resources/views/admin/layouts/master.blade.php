...
<head>
    ...
    <link href="{{asset('templates/admin/conquer/theme/assets/plugins/simple-line-icons/simple-line-icons.min.css')}} " rel="stylesheet" type="text/css"/>
    ...
    <link href="{{asset('templates/admin/conquer/theme/assets/css/style-responsive.css')}} " rel="stylesheet" type="text/css"/>
    <link href="{{asset('templates/admin/conquer/theme/assets/css/plugins.css')}} " rel="stylesheet" type="text/css"/>
    <link href="{{asset('templates/admin/conquer/theme/assets/css/themes/default.css')}} " rel="stylesheet" type="text/css" id="style_color"/>
...
<script src="{{asset('templates/admin/conquer/theme/assets/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js')}}" type="text/javascript"></script>
